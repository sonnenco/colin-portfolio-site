const Card = ({ image, title, description, link }) => {
  return (
    <div className="card relative w-[80vw] max-w-100 my-10 mx-5 overflow-hidden border-4 rounded-xl shadow-[6px_4px_8px_rgba(0,0,0,0.2)] border-slate-300 dark:border-white
    lg:my-2 h-105 md:h-100 lg:h-95">
